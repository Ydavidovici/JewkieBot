#pragma once
// Polyglot Random64 table (781 entries) - canonical source: ddugovic/polyglot book_format.html
// Layout: [0..767]   piece keys, indexed as kPolyRandom[64*piece + 8*row + file]
//                    where piece ordering is BP=0,WP=1,BN=2,WN=3,BB=4,WB=5,BR=6,WR=7,BQ=8,WQ=9,BK=10,WK=11
...
namespace polyglot {
inline constexpr uint64_t kRandom64[781] = {
...
// Named offsets into kRandom64
inline constexpr int kRandomPiece = 0;
inline constexpr int kRandomCastle = 768;
inline constexpr int kRandomEnPassant = 772;
inline constexpr int kRandomTurn = 780;
} // namespace polyglot
